...
public class SellerFormController implements Initializable {
	...
	private Seller getFormData() {
		...
		obj.setIdSeller(Utils.tryParseToInt(txtId.getText()));
		...
		obj.setNameSeller(txtName.getText());
	...
	public void updateFormData() { // responsável por pegar os dados do departamento é popular de texto do
		...
		txtId.setText(String.valueOf(entity.getIdSeller()));
		// txtName.setText(String.valueOf(entity.getNameSeller()));
		txtName.setText(entity.getNameSeller());
	...
	private void initializeComboBoxDepartment() {
		Callback<ListView<Department>, ListCell<Department>> factory = lv -> new ListCell<Department>() {
			...
			protected void updateItem(Department item, boolean empty) {
				...
				setText(empty ? "" : item.getNameDepartment());
			}
		};
