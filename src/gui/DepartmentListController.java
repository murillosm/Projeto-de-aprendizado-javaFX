...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	public void onBtNewAction(ActionEvent event) {
		...
		createDialogForm(obj, "/gui/DepartmentForm.fxml", parantStage);
	}
	...
	private void initializeNode() {
		tableColumnId.setCellValueFactory(new PropertyValueFactory<>("idDepartment")); // iniciar apropriadamente o
		...
		tableViewDepartment.prefHeightProperty().bind(stage.heightProperty());// Faz o tableView acompalhar o tamanho da
																				// janela
